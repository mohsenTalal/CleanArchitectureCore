...
namespace $safeprojectname$.Models
{
    ...
    //: IExamplesProvider
    public class InternalErrorGetExample 
    {

        private readonly IConfiguration configuration;
        public InternalErrorGetExample(IConfiguration config)
        {
        ...
        public object GetExamples()
        {
            ...
            List<EAICustomError> ErrorList = errors.FindAll(x => x.HttpStatus == 500);
